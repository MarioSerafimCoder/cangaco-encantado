...
const CASA_ATLAS := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_base/01_casa_nilo_e_rua_props.png")
const IGREJA_ATLAS := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_base/02_igreja_velha_e_checkpoint.png")
const PRACA_ATLAS := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_base/03_telhados_e_praca_umbu.png")
const BARRACOS_ATLAS := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_base/04_barracos_queimados.png")
const ARMAZEM_ATLAS := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_base/05_armazem_e_patio.png")
const POCO_ATLAS := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_base/06_beco_e_poco_romaozinho.png")
const POSTO_ATLAS := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_base/07_barricada_e_posto_comando.png")
const ARENA_ATLAS := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_base/08_arena_ze_tranca.png")
const CIVIL_ATLAS := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_expansao/01_arquitetura_civil_casas_igreja_beco.png")
const MILITARY_ATLAS := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_expansao/02_arquitetura_armazem_patio_barricada.png")
const GROUND_ATLAS := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_expansao/03_sistema_de_chao_e_transicoes.png")
const FILLER_ATLAS := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_expansao/05_conjuntos_de_transicao_e_preenchimento.png")
const ATMOSPHERE_ATLAS := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_expansao/06_elementos_atmosfericos.png")
const STREET_GROUND := preload("res://assets/sprites/usados/cenarios/vila_umbuzeiro/fundos/rua_chao_continuo.png")
