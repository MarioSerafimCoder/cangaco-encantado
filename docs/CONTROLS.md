...
| Revólver | `K` | Atira; pode manter pressionado. O tambor recarrega automaticamente após 6 tiros. |
...
| Liberar a Vila (debug) | `F12` | Alterna o estado para `LIBERATED` e salva. |
