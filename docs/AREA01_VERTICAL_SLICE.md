...
- Três checkpoints, atalhos persistentes e mapa navegável.
...
- `res://tools/room_production_validation.tscn`: estrutura das treze salas, bounds, chão, entradas e câmera.
- `res://tools/area01_visual_review.tscn`: onze capturas 1920x1080 em `prints_do_jogo/area_01_vertical_slice/`.
