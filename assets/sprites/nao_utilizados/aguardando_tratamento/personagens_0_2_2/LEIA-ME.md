...
|---|---|---|
| `01_rua_village_mid_remover_fundo.png` | `assets/sprites/nao_utilizados/fontes/rua_das_cinzas/rua_village_mid_source.png` | Integrado |
| `02_rua_foreground_remover_fundo.png` | `assets/sprites/nao_utilizados/fontes/rua_das_cinzas/rua_foreground_source.png` | Integrado |
| `03_saqueador_folha.png` | — | Primeira tentativa descartada por ter sido recortada |
| `PENDENTE_03_saqueador_MANTER_1448x1086.png` | `assets/sprites/usados/personagens/inimigos/saqueador_concept_sheet.png` | Integrado em 1448x1086 |
| `04_pistoleiro_folha_remover_fundo.png` | `assets/sprites/usados/personagens/inimigos/pistoleiro_concept_sheet.png` | Integrado |
| `05_ze_tranca_folha_remover_fundo.png` | `assets/sprites/usados/personagens/chefes/ze_tranca_concept_sheet.png` | Integrado |
