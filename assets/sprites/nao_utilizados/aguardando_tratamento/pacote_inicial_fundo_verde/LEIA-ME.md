...
Os oito arquivos foram devolvidos com transparência RGBA real, validados sem alteração de nome ou canvas e integrados ao jogo. Esta pasta permanece como fonte corrigida para futuras revisões; a cópia usada em tempo de execução fica em `assets/sprites/usados/cenarios/vila_umbuzeiro/atlases_base/`.
